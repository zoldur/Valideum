...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='valideum.conf'
CONFIGFOLDER='/root/.valideum'
COIN_DAEMON='valideumd'
COIN_CLI='valideum-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/Basethics/Valideum/releases/download/v3.2.0.9/valideum-linux.tar.gz'
